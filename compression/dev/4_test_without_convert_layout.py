...
def small_mma_kernel(
    ...
    #     meta=1,
    # )
    # print(gl.to_linear_layout(e_reg_layout, (BLOCK_M // 16, BLOCK_K)))
    # e = gl.convert_layout(meta_reordered, e_reg_layout)
    c = c_smem.load(c_layout)

    d = warpgroup_mma(
        a_compressed_smem, b_smem, c, e=meta_reordered, is_async=True, use_acc=True
    )
