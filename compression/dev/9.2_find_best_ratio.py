...
if __name__ == "__main__":
    ...
    for i, (M, N, K) in enumerate(shapes):
        ...
        for config in configs:
            ...
            # --- CALCULATE AND TRACK GLOBAL PEAK RATIO ---
            if dense_tflops > 0:
                current_ratio = runtime_tflops / dense_tflops
                if current_ratio > global_max_ratio:
                    global_max_ratio = current_ratio
                    best_ratio_shape = shape_str
                    best_ratio_config = config_details
