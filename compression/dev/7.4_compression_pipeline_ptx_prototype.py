...
class SparseWGMMA:
    ...
    @gluon.jit
    def ptx_convert_layout(self, a_compressed, BLOCK_M: gl.constexpr, BLOCK_K: gl.constexpr, TRANSPOSE_PTX: gl.constexpr):
        ...
        return a_compressed_swapped

    @gluon.jit
    def generate_compressed_and_meta(self, a_pruned, BLOCK_M : gl.constexpr, BLOCK_K: gl.constexpr, a_compressed_layout: gl.constexpr, LAYOUT_TRANSPOSE_PTX: gl.constexpr):
        ...
        a_compressed = self.ptx_convert_layout(a_compressed, BLOCK_M, BLOCK_K, LAYOUT_TRANSPOSE_PTX)
    ...
    def issue_async_mma(
        ...
        LAYOUT_TRANSPOSE_PTX: gl.constexpr
    ):
        ...
        a_compressed, e = self.generate_compressed_and_meta(a_pruned, BLOCK_M, BLOCK_K, a_compressed_layout, LAYOUT_TRANSPOSE_PTX)
        
        # dummy tensor to test
        a_temp = gl.convert_layout(a_compressed, a_compressed_layout)
...
def sparse_persistent_matmul_pipelined(
    ...
    sparse_persistent_matmul_pipelined_kernel[grid](
        ...
        num_warps=num_warps,
        LAYOUT_TRANSPOSE_PTX = LAYOUT_TRANSPOSE_PTX,
    )


if __name__ == "__main__":
    os.environ["MLIR_ENABLE_DUMP"]="1"
    os.environ["MLIR_DUMP_PATH"] = "./MLIR_DUMP/7.4"
