#!/bin/bash
#SBATCH --job-name=10.1_N=8192        # Job name
#SBATCH --output=10.1_N=8192%j.out    # Output file (%j = job ID)
...
# run benchmark
apptainer exec --nvccli $SCRATCH/sparse.sif python dev/8.10_benchmark_post_compression.py 8192