#!/bin/bash
#SBATCH --job-name=7.2_32_benchmark        # Job name
#SBATCH --output=7.2_32_benchmark_%j.out    # Output file (%j = job ID)
...
# run benchmark
apptainer exec --nv $SCRATCH/sparse.sif python 8.7_benchmark_persistent.py 7.2 16