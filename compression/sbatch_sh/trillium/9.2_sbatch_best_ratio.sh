#!/bin/bash
#SBATCH --job-name=9.2_best_ratio     # Job name
#SBATCH --output=9.2_best_ratio_%j.out    # Output file (%j = job ID)
...
# run benchmark
apptainer exec --nvccli $SCRATCH/sparse.sif python 9.2_find_best_ratio.py 7.2 16