#!/bin/bash
#SBATCH --job-name=7.7.1_N=8192        # Job name
#SBATCH --output=7.7.1_N=8192_%j.out    # Output file (%j = job ID)
...
# run benchmark
apptainer exec --nvccli $SCRATCH/sparse.sif python 8.7.1_benchmark_ws.py 7.7.1 8192