#!/bin/bash
#SBATCH --job-name=7.5_N=8192        # Job name
#SBATCH --output=7.5_N=8192_%j.out    # Output file (%j = job ID)
...
# run benchmark
apptainer exec --nv $SCRATCH/sparse.sif python 8.7_benchmark_persistent.py 7.5 8192