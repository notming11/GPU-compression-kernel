#!/bin/bash
#SBATCH --job-name=7.5.1_max_shape_benchmark        # Job name
#SBATCH --output=7.5.1_max_shape_benchmark_%j.out    # Output file (%j = job ID)
#SBATCH --nodes=1                         # Request 1 node
#SBATCH --gpus-per-node=h100:1                 # Request 1 GPU
#SBATCH --time=08:00:00                   # Max runtime (2hr)
#SBATCH --mem=188G
...
# run benchmark
apptainer exec --nv $SCRATCH/sparse.sif python 8.7_benchmark_persistent.py 7.5.1 128