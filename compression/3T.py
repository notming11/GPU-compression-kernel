...
def small_mma_kernel(
    ...
    # gl.device_print("test", slice_idx)

    a_pruned_reg_layout: gl.constexpr = gl.DotOperandLayout(
        operand_index=0,
        parent=c_layout,
    ...
    # gl.static_print(a_compressed.type)
    ...
    # gl.static_print(meta_reshaped.type)
    ...
    # out_idx_layout: gl.constexpr = gl.DistributedLinearLayout(reg_bases=[[0, 8], [0, 16]], lane_bases=[[0, 1], [0, 2], [0, 4], [0, 32], [0, 64]], warp_bases=[[1, 0], [2, 0]], block_bases=[], shape=[4, 128])
    ...
    # Since a_compress and e is in BlockedLayout, we need to convert layout nontrivially
...
if __name__ == "__main__":
    ...
    os.environ["MLIR_DUMP_PATH"] = "./MLIR_DUMP/3T"
