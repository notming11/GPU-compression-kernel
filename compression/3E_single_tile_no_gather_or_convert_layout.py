...
def small_mma_kernel(
    ...
    if BLOCK_K == 64:
        ...
        a_pruned_reg_layout: gl.constexpr = gl.DistributedLinearLayout(
            reg_bases=[[0, 1], [0, 2], [0, 4], [0, 8], [8, 0], [0, 64]], 
            lane_bases=[[0, 16], [0, 32], [1, 0], [2, 0], [4, 0]], 
            warp_bases=[[16, 0], [32, 0]], 
            block_bases=[], 
            shape=[64, 128]
        ...
        a_pruned_reg_layout: gl.constexpr = gl.DistributedLinearLayout(
            reg_bases=[[0, 1], [0, 2], [0, 4], [0, 8], [8, 0], [0, 64], [0, 128]], 
            lane_bases=[[0, 16], [0, 32], [1, 0], [2, 0], [4, 0]], 
            warp_bases=[[16, 0], [32, 0]], 
            block_bases=[], 
            shape=[64, 256]
    ...
    # gl.static_print(a_pruned_reg_layout.format_tensor_view([BLOCK_M, BLOCK_K]))
...
if __name__ == "__main__":
    ...
    os.environ["MLIR_DUMP_PATH"] = "./MLIR_DUMP/3E"
