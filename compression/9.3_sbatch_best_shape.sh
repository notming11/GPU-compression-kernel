#!/bin/bash
#SBATCH --job-name=9.3_best_shape       # Job name
#SBATCH --output=9.3_best_shape_%j.out    # Output file (%j = job ID)
...
# run benchmark
apptainer exec --nvccli $SCRATCH/sparse.sif python 9.3_find_best_shape.py 7.2 16