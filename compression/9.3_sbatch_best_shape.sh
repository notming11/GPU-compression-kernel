#!/bin/bash
#SBATCH --job-name=9.x_16384x4096x49152       # Job name
#SBATCH --output=9.x_16384x4096x49152_%j.out    # Output file (%j = job ID)
...
# run benchmark
apptainer exec --nv $SCRATCH/sparse.sif python 9.3_find_best_shape.py 7.5 4096