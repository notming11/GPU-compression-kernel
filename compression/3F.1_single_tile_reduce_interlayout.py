...
def small_mma_kernel(
    ...
    e_intermediate = gl.convert_layout(meta_reordered, e_intermediate_layout)
    #######################################################################################
    ...
    e = gl.convert_layout(e_intermediate, e_layout, assert_trivial = False)
...
if __name__ == "__main__":
    ...
    os.environ["MLIR_DUMP_PATH"] = "./MLIR_DUMP/3F.1"
